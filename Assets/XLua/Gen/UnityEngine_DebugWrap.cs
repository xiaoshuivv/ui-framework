...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineDebugWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 19, 4, 2);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "LogOnce", _m_LogOnce_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ClearLogOnceRecorder", _m_ClearLogOnceRecorder_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LogOnce_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Debug.LogOnce( _message, _id );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ClearLogOnceRecorder_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Debug.ClearLogOnceRecorder(  );
