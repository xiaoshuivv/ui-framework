...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMonoBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EnableScriptReloadInCheckConsistency", _m_EnableScriptReloadInCheckConsistency_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EnableScriptReloadInCheckConsistency_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.MonoBehaviour.EnableScriptReloadInCheckConsistency( _val );
