...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 12, 5);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IsCloudResource", _m_IsCloudResource);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "TriggerCloudResourceDownload", _m_TriggerCloudResourceDownload);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsCloudResource(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsCloudResource(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_TriggerCloudResourceDownload(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.TriggerCloudResourceDownload(  );
